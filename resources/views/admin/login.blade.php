...
<div class="log-w3">
    <div class="w3layouts-main">
        ...
        <p>Bạn không có mật khẩu à?<a href="dang-ky">Tạo tài khoản đi</a></p>
    </div>
</div>
...
<!--[if lte IE 8]>
<script language="javascript" type="text/javascript" src="{{asset('frontend/js/flot-chart/excanvas.min.js')}}"></script><![endif]-->
